"""
Django settings for brag_document_project project.
...
SECRET_KEY = 'django-insecure-j8npqydbf5=b+a98(@3f1&_8t4r@w9f&67hg2y2-k+*wj9hqwq'
...
WSGI_APPLICATION = 'brag_document_project.wsgi.application'
